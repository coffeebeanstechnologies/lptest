...
var CreateQuestionComponent = /** @class */ (function () {
    ...
    //   allowSearchFilter: true
    // };
    function CreateQuestionComponent(dal) {
        this.dal = dal;
        this.question = {
    ...
    CreateQuestionComponent.prototype.addRow = function () {
        var opt = { optionName: "", isCorrectAnswer: false };
        this.options.push(opt);
    };
    CreateQuestionComponent.prototype.addPairRow = function () {
        var opt = { optionId: this.optionMatch.length + 1, optionText: "", optionMatch: "" };
        this.optionMatch.push(opt);
    };
    CreateQuestionComponent.prototype.removeRow = function (id) {
        // this.options = this.options.filter(x=> x.optionId != id);
    };
    CreateQuestionComponent.prototype.getAllClasses = function () {
        var _this = this;
        this.dal.getAllClasses().subscribe(function (x) {
            _this.classList = x;
            console.log("classlist", x);
        });
    };
    CreateQuestionComponent.prototype.getAllBoards = function () {
        var _this = this;
        this.dal.getAllBoards().subscribe(function (x) {
            _this.boardList = x;
            console.log("boardlist", x);
        });
    };
    CreateQuestionComponent.prototype.getAllSubjects = function () {
        var _this = this;
        this.dal.getallSubjects().subscribe(function (x) {
            _this.subjectList = x;
    ...
    CreateQuestionComponent.prototype.addQuestion = function () {
        ...
        this.dal.addQuestion(this.question).subscribe(function (x) {
            if (x.status == "success") {
...
var CreateTestComponent = /** @class */ (function () {
    function CreateTestComponent(dal) {
        this.dal = dal;
    }
    CreateTestComponent.prototype.ngOnInit = function () {
        this.getAllQuestions();
    };
    CreateTestComponent.prototype.getAllQuestions = function () {
        var _this = this;
        this.dal.getAllQuestions().subscribe(function (x) {
            _this.allQuestions = x;
            console.log("all questions", x);
        });
    };
    CreateTestComponent.ctorParameters = function () { return [
        { type: src_app_services_dal_service__WEBPACK_IMPORTED_MODULE_2__["DalService"] }
    ]; };
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getAllTests = function () {
        var _this = this;
        this.dal.getAllTests().subscribe(function (x) {
            _this.allTests = x;
...
var QuestionBankComponent = /** @class */ (function () {
    function QuestionBankComponent(dal) {
        this.dal = dal;
    ...
    QuestionBankComponent.prototype.getAllQuestions = function () {
        var _this = this;
        this.dal.getAllQuestions().subscribe(function (x) {
            _this.allQuestions = x.questions;
            console.log("all questions", x.questions);
        });
    };
    QuestionBankComponent.prototype.getAllClasses = function () {
        var _this = this;
        this.dal.getAllClasses().subscribe(function (x) {
            _this.classList = x;
            console.log("classlist", x);
    ...
    QuestionBankComponent.prototype.getAllBoards = function () {
        var _this = this;
        this.dal.getAllBoards().subscribe(function (x) {
            _this.boardList = x;
            console.log("boardlist", x);
    ...
    QuestionBankComponent.prototype.getAllSubjects = function () {
        var _this = this;
        this.dal.getallSubjects().subscribe(function (x) {
            _this.subjectList = x;
            console.log("subjectlist", x);
    ...
    QuestionBankComponent.prototype.getQuestionById = function (data) {
    ...
    QuestionBankComponent.prototype.onSubjectSelect = function (event, data) {
        data = event;
        console.log("on subject select", event);
    };
    QuestionBankComponent.prototype.onClassSelect = function (event) {
        //UpdatedQuestion.classInfo = event
        console.log("on class select", event);
    };
    QuestionBankComponent.prototype.onBoardSelect = function (event) {
        console.log("on board select", event);
    };
    QuestionBankComponent.prototype.updateQuestion = function (data) {
        var _this = this;
        this.questionToUpdate.questionId = data.questionId;
        this.questionToUpdate.question = data.question;
        this.questionToUpdate.isImageAvailable = data.isImageAvailable;
        ...
        this.dal.updateQuestion(data).subscribe(function (x) {
            if (x.status == "success") {
    ...
    QuestionBankComponent.prototype.addRow = function () {
        var opt = { optionName: "", isCorrectAnswer: false };
        this.questionToUpdate.options.push(opt);
    };
    QuestionBankComponent.prototype.addPairRow = function () {
        var opt = { optionName: "", isCorrectAnswer: false };
        this.questionToUpdate.options.push(opt);
    };
    QuestionBankComponent.ctorParameters = function () { return [
        { type: src_app_services_dal_service__WEBPACK_IMPORTED_MODULE_2__["DalService"] }
    ]; };
...
var QuestionSetWithQuestionComponent = /** @class */ (function () {
    function QuestionSetWithQuestionComponent(dal) {
        this.dal = dal;
        this.questionSetWithQuestions = new _models_queSetWithQuestions_model__WEBPACK_IMPORTED_MODULE_2__["queSetWithQuestions"]();
    }
    QuestionSetWithQuestionComponent.prototype.ngOnInit = function () {
        this.getAllSetList();
        this.getAllQuestions();
    };
    QuestionSetWithQuestionComponent.prototype.getAllSetList = function () {
        var _this = this;
        this.dal.getAllSetList().subscribe(function (x) {
            _this.allQuestionSets = x.questionSets;
            console.log("all set list", x);
        });
    };
    QuestionSetWithQuestionComponent.prototype.getAllQuestions = function () {
        var _this = this;
        this.dal.getAllQuestions().subscribe(function (x) {
            _this.allQuestions = x.questions;
            console.log("all questions", x.questions);
    ...
    QuestionSetWithQuestionComponent.prototype.getSelectedQuestions = function (data) {
        if (data.questionPaperSetId == undefined) {
            ...
            if (this.questionIds == undefined || !this.questionIds.length) {
                ...
                var questions = this.questionIds.map(function (x) {
                ...
                this.dal.saveQuestionPaperSetWithQuestions(this.questionSetWithQuestions).subscribe(function (x) {
                    if (x.status == "success") {
    ...
    QuestionSetWithQuestionComponent.ctorParameters = function () { return [
        { type: src_app_services_dal_service__WEBPACK_IMPORTED_MODULE_3__["DalService"] }
    ]; };
    ...
    return QuestionSetWithQuestionComponent;
}());
...
var QuestionSetComponent = /** @class */ (function () {
    function QuestionSetComponent(dal) {
        this.dal = dal;
    ...
    QuestionSetComponent.prototype.getAllSetList = function () {
        var _this = this;
        this.dal.getAllSetList().subscribe(function (x) {
            _this.allQuestionSets = x.questionSets;
            console.log("all set list", x);
    ...
    QuestionSetComponent.prototype.getAllClasses = function () {
        var _this = this;
        this.dal.getAllClasses().subscribe(function (x) {
            _this.classList = x;
            //console.log("classlist",x)
    ...
    QuestionSetComponent.prototype.getAllBoards = function () {
        var _this = this;
        this.dal.getAllBoards().subscribe(function (x) {
            _this.boardList = x;
            //console.log("boardlist",x)
    ...
    QuestionSetComponent.prototype.getAllSubjects = function () {
        var _this = this;
        this.dal.getallSubjects().subscribe(function (x) {
            _this.subjectList = x;
            //console.log("subjectlist",x)
    ...
    QuestionSetComponent.prototype.addQuestionSet = function (data) {
        var _this = this;
        ...
        this.dal.saveQuestionPaperSet(data).subscribe(function (x) {
            if (x.status == "success") {
                console.log("set saved success!", x);
                _this.questionSetToAdd = new _models_questionSet_model__WEBPACK_IMPORTED_MODULE_3__["questionSet"]();
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default.a.fire({
                    icon: 'success',
                    title: "Success!",
    ...
    QuestionSetComponent.ctorParameters = function () { return [
        { type: src_app_services_dal_service__WEBPACK_IMPORTED_MODULE_2__["DalService"] }
    ]; };
...
var TestBankComponent = /** @class */ (function () {
    function TestBankComponent(dal) {
        this.dal = dal;
    }
    TestBankComponent.prototype.ngOnInit = function () {
        this.getAllTests();
    };
    TestBankComponent.prototype.getAllTests = function () {
        var _this = this;
        this.dal.getAllTests().subscribe(function (x) {
            _this.allTests = x;
            console.log("all tests", x);
    ...
    TestBankComponent.ctorParameters = function () { return [
        { type: src_app_services_dal_service__WEBPACK_IMPORTED_MODULE_2__["DalService"] }
    ]; };
...
var queSetWithQuestions = /** @class */ (function () {
    function queSetWithQuestions() {
    }
    return queSetWithQuestions;
}());
...
var questionSet = /** @class */ (function () {
...
var UpdatedQuestion = /** @class */ (function () {
...
var CustomHttpService = /** @class */ (function () {
    ...
    CustomHttpService.prototype.setheaders = function () {
        this.authHeaders =
...
var DalService = /** @class */ (function () {
    ...
    DalService.prototype.setheaders = function () {
        this.authHeaders =
    ...
    DalService.prototype.getAllQuestions = function () {
    ...
    DalService.prototype.getAllSetQuestionsWithSetId = function (setId) {
